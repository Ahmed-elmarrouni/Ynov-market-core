  ...
  componentDidMount() {
    this.props.onLoad(
      Promise.all([
        ...
        agent.Articles.byAuthor(this.props.username),
      ])
    );
  }
...
// Wrapper to inject useParams into class component
function Profile(props) {
  const { username } = useParams();
  return <ProfileInner {...props} username={username} />;
}

const ConnectedProfile = connect(mapStateToProps, mapDispatchToProps)(Profile);
export default ConnectedProfile;
export { ProfileInner as Profile, mapStateToProps };
